<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Early.aspx.cs" Inherits="Sonata4.Stage2.Early" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
	<div data-role="page" class="wlby_movie">
		...
		<div class="wlby_graphic">
			<input type="image" id="imgBg" class="wlby_49 auto-scale" src="../Images/p3/p33.jpg" style="width: 540px; height: 850.5px" />
		</div>
